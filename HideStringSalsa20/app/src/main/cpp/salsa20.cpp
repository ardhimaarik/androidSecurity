...
extern "C" {
	JNIEXPORT jlong Java_com_kirra_hidestringsalsa20_salsa20_Salsa20ImplNative_nativeSetup(JNIEnv *env, jobject thiz, jbyteArray _key, jbyteArray _nonce, jint rounds) {
	...
	JNIEXPORT void Java_com_kirra_hidestringsalsa20_salsa20_Salsa20ImplNative_nativeSetPosition(JNIEnv *env, jobject thiz, jlong obj, jlong pos) {
		Salsa20ImplNative *s = (Salsa20ImplNative*) obj;
		s->setPosition((u64) pos);
	}

	JNIEXPORT jlong Java_com_kirra_hidestringsalsa20_salsa20_Salsa20ImplNative_nativeGetPosition(JNIEnv *env, jobject thiz, jlong obj) {
		Salsa20ImplNative *s = (Salsa20ImplNative*) obj;
		return (jlong) s->getPosition();
	}

	JNIEXPORT void Java_com_kirra_hidestringsalsa20_salsa20_Salsa20ImplNative_nativeCrypt(JNIEnv *env, jobject thiz, jlong obj, jbyteArray _in, jint inOffset, jbyteArray _out, jint outOffset, jint len) {
